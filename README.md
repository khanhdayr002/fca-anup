...
## Install
If you just want to use fca-anup, you should use this command:
```bash
npm install fca-anup
```
It will download `fca-anup` from NPM repositories
...
- [anup](https://github.com/Anupx0/Anupbot) - A simple Facebook Messenger Bot made by CatalizCS and SpermLord.
